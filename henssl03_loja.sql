...
--
-- Host: localhost:3306
-- Tempo de geração: 13/01/2022 às 15:22
...
CREATE TABLE `avaliacao` (
  ...
  `codEstrela` int(11) DEFAULT NULL
...
INSERT INTO `avaliacao` (`idAvaliacao`, `descricao`, `dataPublicacao`, `codProduto`, `codEstrela`) VALUES
(1, 'Ótimo produto, não atrasou na entrega, tive algumas dúvidas sobre o dispositivo e me auxiliaram', '2022-01-10', 1, 2);
...
CREATE TABLE `boleto` (
  ...
  `codigoBarras` varchar(126) DEFAULT NULL,
  `validadeBoleto` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `carrinho` (
  ...
  `codProdutoCarrinho` int(11) DEFAULT NULL,
...
INSERT INTO `carrinho` (`idCarrinho`, `quantidade`, `codProdutoCarrinho`, `pk_usuario`) VALUES
(1, 1, 1, 1),
(2, 2, 1, 1),
(3, 5, 4, 1),
(4, 1, 1, 1),
...
--
-- Estrutura para tabela `cartaocredito`
--

CREATE TABLE `cartaocredito` (
  `idCartaoCredito` int(11) NOT NULL,
  `nomeImpresso` varchar(128) DEFAULT NULL,
  `numeroCartao` char(30) DEFAULT NULL,
  `CVV` char(8) DEFAULT NULL,
  `validadeCartao` char(8) DEFAULT NULL,
  `numeroParcelas` char(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `categoria` (
  `idCategora` int(11) NOT NULL,
  `nomeCategoria` varchar(75) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `categoria` (`idCategora`, `nomeCategoria`) VALUES
(1, 'Smartpones'),
(2, 'Philco'),
(3, 'Apple');
...
INSERT INTO `categoria_produto` (`idCategoria`, `codCategoria`, `codProduto`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 3, 4),
(4, 2, 3);
...
--
-- Estrutura para tabela `categoria_sub`
--

CREATE TABLE `categoria_sub` (
  `idCategoriaSub` int(11) NOT NULL,
  `codCategoria` int(11) DEFAULT NULL,
  `nomeSub` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Despejando dados para a tabela `categoria_sub`
--

INSERT INTO `categoria_sub` (`idCategoriaSub`, `codCategoria`, `nomeSub`) VALUES
(1, 1, 'Galax A32'),
(2, 1, 'Galax 02'),
(3, 1, 'Galax 52'),
(4, 1, 'Galax 72'),
...
INSERT INTO `cidade` (`idCidade`, `nomeCidade`, `codUF`, `ibge`) VALUES
...
CREATE TABLE `empresa` (
  ...
  `cnpjEmpresa` char(26) DEFAULT NULL,
  `enderecoRua` varchar(150) DEFAULT NULL,
  `numero` int(11) DEFAULT NULL,
  `complemento` char(5) DEFAULT NULL,
...
--
-- Estrutura para tabela `endereco_pricipal`
--

CREATE TABLE `endereco_pricipal` (
  `idEnderecoPrincipal` int(11) NOT NULL,
  `situacao_endereco` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Despejando dados para a tabela `endereco_pricipal`
--

INSERT INTO `endereco_pricipal` (`idEnderecoPrincipal`, `situacao_endereco`) VALUES
(1, 'Sim'),
(2, 'Não');
...
INSERT INTO `estado` (`idEstado`, `nomeEstado`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 0, 0, 0),
(2, 'Alagoas', 'AL', 0, 0, 0),
(3, 'Amazonas', 'AM', 0, 0, 0),
(4, 'Amapá', 'AP', 0, 0, 0),
(5, 'Bahia', 'BA', 0, 0, 0),
(6, 'Ceará', 'CE', 0, 0, 0),
(7, 'Distrito Federal', 'DF', 0, 0, 0),
(8, 'Espírito Santo', 'ES', 0, 0, 0),
(9, 'Goiás', 'GO', 0, 0, 0),
(10, 'Maranhão', 'MA', 0, 0, 0),
(11, 'Minas Gerais', 'MG', 0, 0, 0),
(12, 'Mato Grosso do Sul', 'MS', 0, 0, 0),
(13, 'Mato Grosso', 'MG', 0, 0, 0),
(14, 'Pará', 'PA', 0, 0, 0),
(15, 'Paraíba', 'PB', 0, 0, 0),
(16, 'Pernambuco', 'PE', 0, 0, 0),
(17, 'Piauí', 'PI', 0, 0, 0),
(18, 'Paraná', 'PR', 0, 0, 0),
(19, 'Rio de Janeiro', 'RJ', 0, 0, 0),
(20, 'Rio Grande do Norte', 'RN', 0, 0, 0),
(21, 'Rondônia', 'RO', 0, 0, 0),
(22, 'Roraima', 'RR', 0, 0, 0),
(23, 'Rio Grande do Sul', 'RS', 0, 0, 0),
(24, 'Santa Catarins', 'SC', 0, 0, 0),
(25, 'Sergipe', 'SE', 0, 0, 0),
(26, 'São Paulo', 'SP', 0, 0, 0),
(27, 'Tocantins', 'TO', 0, 0, 0);
...
CREATE TABLE `estrelas` (
  `idEstrelas` int(11) NOT NULL,
  `tipoEstrela` int(10) DEFAULT NULL,
  `statusEstrela` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `estrelas` (`idEstrelas`, `tipoEstrela`, `statusEstrela`) VALUES
(1, 100, 'Excelente'),
(2, 75, 'Otimo'),
(3, 50, 'Bom'),
(4, 25, 'Regular'),
...
CREATE TABLE `genero` (
  ...
  `tipoGenero` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `marca` (
  ...
  `nomeFabricante` varchar(120) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `marca` (`idMarca`, `nomeFabricante`) VALUES
(1, 'Apple'),
(2, 'Sansung'),
(3, 'Eletrolux'),
(4, 'Philco\r\n');
...
--
-- Estrutura para tabela `modopagamento`
--

CREATE TABLE `modopagamento` (
  `idModoPagamento` int(11) NOT NULL,
  `codCarrinho` int(11) DEFAULT NULL,
  `boleto` char(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pix` char(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nomeImpresso` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `numeroCartao` char(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cvv` char(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `validadeCartao` char(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `numeroParcelas` int(11) DEFAULT NULL,
  `value` varchar(45) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `modopagamento`
--
...
--
-- Estrutura para tabela `pedidofechado`
--

CREATE TABLE `pedidofechado` (
  `idPedidoFechado` int(11) NOT NULL,
  `codUsuario` int(11) NOT NULL,
  `codModopagamento` int(11) NOT NULL,
  `data` date NOT NULL,
  `entrega` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `pedidofechado`
--

INSERT INTO `pedidofechado` (`idPedidoFechado`, `codUsuario`, `codModopagamento`, `data`, `entrega`) VALUES
(1, 1, 2, '2022-01-13', '2040-12-31'),
(2, 1, 2, '2022-01-13', '2040-12-31'),
(3, 1, 2, '2022-01-13', '2040-12-31'),
(4, 1, 2, '2022-01-13', '2040-12-31'),
(5, 1, 2, '2022-01-13', '2040-12-31'),
(6, 1, 2, '2022-01-13', '2040-12-31');

-- --------------------------------------------------------

--
-- Estrutura para tabela `peido_status`
--

CREATE TABLE `peido_status` (
  `idPeididoStatus` int(11) NOT NULL,
  `codPedido` int(11) DEFAULT NULL,
  `codStatus` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `peido_status`
--

INSERT INTO `peido_status` (`idPeididoStatus`, `codPedido`, `codStatus`) VALUES
(1, 6, 1);
...
CREATE TABLE `pix` (
  ...
  `chavesAleatorias` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `produto` (
  ...
  `informacoesProduto` varchar(5000) DEFAULT NULL,
  `descricaoProduto` varchar(5000) DEFAULT NULL,
  `imagemDestagada` varchar(250) DEFAULT NULL,
  `valor` decimal(6,2) NOT NULL,
  `pesoProduto` varchar(45) DEFAULT NULL,
  `codMarca` int(11) NOT NULL,
  `desconto` int(11) DEFAULT NULL,
  `valorDesconto` decimal(6,2) DEFAULT NULL,
  `parceladoAte` int(11) DEFAULT NULL,
  `parceladoValor` decimal(6,2) DEFAULT NULL,
  `quantidade` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `produto` (`idProduto`, `nomeProduto`, `informacoesProduto`, `descricaoProduto`, `imagemDestagada`, `valor`, `pesoProduto`, `codMarca`, `desconto`, `valorDesconto`, `parceladoAte`, `parceladoValor`, `quantidade`) VALUES
(1, 'Smartphone Samsung Galaxy A32 128GB 4G Wi-Fi Tela 6.4\'\' Dual Chip 4GB RAM Câmera Quádrupla + Selfie 20MP - Violeta', NULL, 'Descrição do produto\r\nAproveite a tela FHD+ de 6,4 polegadas para assistir aos seus conteúdos no favoritos. Mergulhe na cena dos seus programas de comédia ou na ação dos seus jogos com o Display Infinito do Galaxy A32.\r\n\r\nModelo: Galaxy A32\r\nPN: SM-A325MLVKZTO\r\nCor: Violeta\r\nMarca: Samsung\r\n\r\nTela infinita de 6.4\" com vidro reforçado\r\nTecnologia: Super Amoled\r\nNúmero de Pixels: 1080 x 2400\r\nResolução: FHD+\r\n\r\nSistema operacional: Android 11.0\r\nPlataforma: 64bit\r\nNúmero de núcleos: Octa-Core\r\nVel', '2969968357_1SZ.jpg', 1327.50, '370g', 2, 10, 1255.00, 2, 677.03, 259),
(2, 'Smartphone Samsung Galaxy A32 128GB 4G Wi-Fi Tela 6.4\'\' Dual Chip 4GB RAM Câmera Quádrupla + Selfie 20MP - Azul', NULL, 'Descrição do produto\r\nAproveite a tela FHD+ de 6,4 polegadas para assistir aos seus conteúdos no favoritos. Mergulhe na cena dos seus programas de comédia ou na ação dos seus jogos com o Display Infinito do Galaxy A32.\r\n\r\nModelo: Galaxy A32\r\nPN: SM-A325MLVKZTO\r\nCor: Violeta\r\nMarca: Samsung\r\n\r\nTela infinita de 6.4\" com vidro reforçado\r\nTecnologia: Super Amoled\r\nNúmero de Pixels: 1080 x 2400\r\nResolução: FHD+\r\n\r\nSistema operacional: Android 11.0\r\nPlataforma: 64bit\r\nNúmero de núcleos: Octa-Core\r\nVel', '2969966685_1SZ.jpg', 1327.50, '370g', 2, NULL, NULL, 1, 26.55, 260),
(3, 'Fone de Ouvido Philips TAUH202 Bluetooth Wireless com Microfone e até 15 horas de bateria - Preto', 'Fone Bluetooth Philips TAUH202 - Phillips<br>\r\nHeadphone Philips Bluetooth Listas de reprodução épicas. Os podcasts mais recentes. Esses fones de ouvido auriculares sem fio proporcionam som nítido e graves potentes. A alça é tão leve que você mal a sentirá, e os fones se dobram. Características: - Com carregamento rápido, nada pode parar você e suas playlists - Com a tecnologia sem fio Bluetooth 4.2, que te deixa livre daquela bagunça de fios - O microfone com cancelamento de eco integrado mantém o som com clareza enquanto você treina, e ainda permite que você realize suas ligações sem tocar no smartphone - O design elegante de almofadas macias com entradas de ar proporcionam mais conforto durante longas horas de reprodução. Perfeito para o seu dia a dia Especificações: - Modelo: UH202 - Cor: Preto - Tamanho do driver: 32mm - Potência (mW): 10mW - Frequência de resposta: 20-20.000 Hz - Sensibilidade: 102dB - Bluetooth 4.2 Conteúdo da embalagem: - 1 Headphone Philips - Manual de instruções - Garantia: 12 meses', 'Fone Bluetooth Philips TAUH202 - Phillips\r\nHeadphone Philips Bluetooth Listas de reprodução épicas. Os podcasts mais recentes. Esses fones de ouvido auriculares sem fio proporcionam som nítido e graves potentes. A alça é tão leve que você mal a sentirá, e os fones se dobram. Características: - Com carregamento rápido, nada pode parar você e suas playlists - Com a tecnologia sem fio Bluetooth 4.2, que te deixa livre daquela bagunça de fios - O microfone com cancelamento de eco integrado mantém o som com clareza enquanto você treina, e ainda permite que você realize suas ligações sem tocar no smartphone - O design elegante de almofadas macias com entradas de ar proporcionam mais conforto durante longas horas de reprodução. Perfeito para o seu dia a dia Especificações: - Modelo: UH202 - Cor: Preto - Tamanho do driver: 32mm - Potência (mW): 10mW - Frequência de resposta: 20-20.000 Hz - Sensibilidade: 102dB - Bluetooth 4.2 Conteúdo da embalagem: - 1 Headphone Philips - Manual de instruções - Garantia: 12 meses', '1819240977_4SZ.jpg', 119.98, '190g', 2, NULL, NULL, NULL, NULL, 261),
(4, 'Apple iPhone 13 Pro (128GB) - Dourado', NULL, NULL, '4083448897_1.jpg', 9499.98, '170g', 1, 5, 9024.98, 5, 1901.00, 262);
...
CREATE TABLE `statuspedido` (
  ...
  `tipoStatus` char(25) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `statuspedido` (`idStatusPedidos`, `tipoStatus`) VALUES
(1, 'pedido recebido'),
(2, 'pagamento aprovado'),
(3, 'nota fiscal disponível'),
(4, 'em transporte'),
(5, 'pedido entregue'),
(6, 'esperando pagamento'),
(7, 'boleto vencido');
...
ALTER TABLE `avaliacao`
  ...
  ADD KEY `pk_avalicao_estrelas` (`codEstrela`),
  ADD KEY `pk_produto_avaliado` (`codProduto`);
...
ALTER TABLE `carrinho`
  ...
  ADD KEY `pk_carrinho_produto` (`codProdutoCarrinho`),
  ADD KEY `usuario_pk_carrinho` (`pk_usuario`);

--
-- Índices de tabela `cartaocredito`
--
...
ALTER TABLE `categoria_produto`
  ...
  ADD KEY `pk_produto_categoriaProduto` (`codProduto`),
  ADD KEY `pk_categoriasProduto_produto` (`codCategoria`);

--
-- Índices de tabela `categoria_sub`
--
ALTER TABLE `categoria_sub`
  ADD PRIMARY KEY (`idCategoriaSub`),
  ADD KEY `pk_categoria_categoriasub` (`codCategoria`);
...
ALTER TABLE `cidade`
  ...
  ADD KEY `pk_cidade_estado` (`codUF`);
...
ALTER TABLE `empresa`
  ...
  ADD KEY `pk_empresa_cidade` (`codCity`);
...
ALTER TABLE `endereco`
  ...
  ADD KEY `pk_endereco_cidade` (`codCidade`),
  ADD KEY `pk_endereco_usuario` (`codUsuario`),
  ADD KEY `pk_endereco_principal` (`principal`);

--
-- Índices de tabela `endereco_pricipal`
--
ALTER TABLE `endereco_pricipal`
  ADD PRIMARY KEY (`idEnderecoPrincipal`);
...
--
-- Índices de tabela `modopagamento`
--
ALTER TABLE `modopagamento`
  ADD PRIMARY KEY (`idModoPagamento`),
  ADD KEY `pk_modopagamento_carrinho` (`codCarrinho`);

--
-- Índices de tabela `pedidofechado`
--
ALTER TABLE `pedidofechado`
  ADD PRIMARY KEY (`idPedidoFechado`),
  ADD KEY `pk_codUsuario` (`codUsuario`),
  ADD KEY `pk_codModopagamento` (`codModopagamento`);

--
-- Índices de tabela `peido_status`
--
ALTER TABLE `peido_status`
  ADD PRIMARY KEY (`idPeididoStatus`),
  ADD KEY `pk_pedidos_peidostatus` (`codPedido`),
  ADD KEY `pk_status_peidostatus` (`codStatus`);
...
ALTER TABLE `produto`
  ...
  ADD KEY `pk_produto_marca` (`codMarca`),
  ADD KEY `pk_produto_categoria` (`desconto`);
...
--
ALTER TABLE `cartaocredito`
  MODIFY `idCartaoCredito` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `categoria`
--
ALTER TABLE `categoria`
  MODIFY `idCategora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de tabela `categoria_sub`
--
ALTER TABLE `categoria_sub`
  MODIFY `idCategoriaSub` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `cidade`
--
ALTER TABLE `cidade`
  MODIFY `idCidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5611;
...
--
-- AUTO_INCREMENT de tabela `endereco_pricipal`
--
ALTER TABLE `endereco_pricipal`
  MODIFY `idEnderecoPrincipal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `estrelas`
  MODIFY `idEstrelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT de tabela `modopagamento`
--
ALTER TABLE `modopagamento`
  MODIFY `idModoPagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `pedidofechado`
--
ALTER TABLE `pedidofechado`
  MODIFY `idPedidoFechado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `peido_status`
--
ALTER TABLE `peido_status`
  MODIFY `idPeididoStatus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `pix`
--
ALTER TABLE `pix`
  MODIFY `idPix` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `statuspedido`
  MODIFY `idStatusPedidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `avaliacao`
  ADD CONSTRAINT `pk_avalicao_estrelas` FOREIGN KEY (`codEstrela`) REFERENCES `estrelas` (`idEstrelas`),
  ADD CONSTRAINT `pk_produto_avaliado` FOREIGN KEY (`codProduto`) REFERENCES `produto` (`idProduto`);

--
-- Restrições para tabelas `carrinho`
--
ALTER TABLE `carrinho`
  ADD CONSTRAINT `pk_carrinho_produto` FOREIGN KEY (`codProdutoCarrinho`) REFERENCES `produto` (`idProduto`),
  ADD CONSTRAINT `usuario_pk_carrinho` FOREIGN KEY (`pk_usuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Restrições para tabelas `categoria_produto`
--
ALTER TABLE `categoria_produto`
  ADD CONSTRAINT `pk_categoriasProduto_produto` FOREIGN KEY (`codCategoria`) REFERENCES `categoria` (`idCategora`),
  ADD CONSTRAINT `pk_produto_categoriaProduto` FOREIGN KEY (`codProduto`) REFERENCES `produto` (`idProduto`);

--
-- Restrições para tabelas `categoria_sub`
--
ALTER TABLE `categoria_sub`
  ADD CONSTRAINT `pk_categoria_categoriasub` FOREIGN KEY (`codCategoria`) REFERENCES `categoria` (`idCategora`);

--
-- Restrições para tabelas `cidade`
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `pk_cidade_estado` FOREIGN KEY (`codUF`) REFERENCES `estado` (`idEstado`);

--
-- Restrições para tabelas `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `pk_empresa_cidade` FOREIGN KEY (`codCity`) REFERENCES `cidade` (`idCidade`);

--
-- Restrições para tabelas `endereco`
--
ALTER TABLE `endereco`
  ADD CONSTRAINT `pk_endereco_cidade` FOREIGN KEY (`codCidade`) REFERENCES `cidade` (`idCidade`),
  ADD CONSTRAINT `pk_endereco_principal` FOREIGN KEY (`principal`) REFERENCES `endereco_pricipal` (`idEnderecoPrincipal`),
  ADD CONSTRAINT `pk_endereco_usuario` FOREIGN KEY (`codUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Restrições para tabelas `modopagamento`
--
ALTER TABLE `modopagamento`
  ADD CONSTRAINT `pk_modopagamento_carrinho` FOREIGN KEY (`codCarrinho`) REFERENCES `carrinho` (`idCarrinho`);

--
-- Restrições para tabelas `pedidofechado`
--
ALTER TABLE `pedidofechado`
  ADD CONSTRAINT `pk_codModopagamento` FOREIGN KEY (`codModopagamento`) REFERENCES `modopagamento` (`idModoPagamento`),
  ADD CONSTRAINT `pk_codUsuario` FOREIGN KEY (`codUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Restrições para tabelas `peido_status`
--
ALTER TABLE `peido_status`
  ADD CONSTRAINT `pk_pedidos_peidostatus` FOREIGN KEY (`codPedido`) REFERENCES `pedidofechado` (`idPedidoFechado`),
  ADD CONSTRAINT `pk_status_peidostatus` FOREIGN KEY (`codStatus`) REFERENCES `statuspedido` (`idStatusPedidos`);

--
-- Restrições para tabelas `produto`
--
ALTER TABLE `produto`
  ADD CONSTRAINT `pk_produto_marca` FOREIGN KEY (`codMarca`) REFERENCES `marca` (`idMarca`);

--
-- Restrições para tabelas `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `pk_genero` FOREIGN KEY (`codGenero`) REFERENCES `genero` (`idGenero`);
COMMIT;
