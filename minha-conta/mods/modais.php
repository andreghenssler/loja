...
<div class="modal fade" id="cadastroEndereco_c" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		    	...
		    	<form method="POST" id="c_endereco_meus">
		      		...
		      		<div class="form-group row">
				        ...
				        <div class="col-md-6">
				        	...
				        	<select class="custom-select custom-select" id="cidades" name="cidades"><option value="0">Escolha a sua Cidade</option></select>
				        </div>
		      		</div>
		      		<div class="form-group row">
				        <div class="col-md-6">
